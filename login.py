...
if __name__=="__main__":
    ...
    eid=StringVar()
    psw=StringVar()
    label=Label(root,text="LOGIN",font="bold",fg="Black")
    ...
    b4=Button(root,text="Submit",command=pos,activebackground="pink",bg="lightblue",width=30)
    b4.place(x=363,y=200)
    b3=Button(root,text="Close",command=clse,bg="lightblue",activebackground="red",width=30)
